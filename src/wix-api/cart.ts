...
export async function addToCart(
  wixClient: WixClient,
  { product, selectedOption, quantity }: AddToCartValues
) {
  const selectedVariant = findVariant(product, selectedOption);
...
// SE CODE EST UTILISABLE DANS PLUSIEUR COMPOSANST
