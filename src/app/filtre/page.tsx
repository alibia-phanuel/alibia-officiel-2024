...
import { ProductsSort, queryProducts } from "@/wix-api/product";
  ...
  return (
    <div className="space-y-10 group-has-[[data-pending]]:animate-pulse">
      <p className="text-center text-xl">
        {products.totalCount}{" "}
        {products.totalCount === 1 ? "produit" : "produits"} trouvé
      </p>
      ...
      <PaginationBar currentPage={page} totalPage={products.totalPages || 1} />
    </div>
  );
}
