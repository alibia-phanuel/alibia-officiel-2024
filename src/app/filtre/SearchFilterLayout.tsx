...
import { ProductsSort } from "@/wix-api/product";
...
function PriceFilter({
  ...
  return (
    <div className="space-y-3">
      <div className="font-bold">Fourchette de prix</div>
...
function SortFilter({ sort, updateSort }: SortFilterProps) {
  return (
    <Select value={sort || "last_updated"} onValueChange={updateSort}>
      ...
      <SelectContent>
        <SelectItem value="last_updated">Le plus récent</SelectItem>
        <SelectItem value="price_asc">Prix (De faible à élevé)</SelectItem>
        <SelectItem value="price_desc">Prix (De haut en bas )</SelectItem>
      </SelectContent>
    </Select>
  );
}
