    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            Vous avez aimé ce produit ? Partagez vos impressions avec
            d&apos;autres clients.
          </DialogDescription>
        </DialogHeader>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Textarea
                        placeholder="Racontez votre expérience à d'autres..."
                        {...field}
                      />
                    </FormControl>
                    <FormMessage />
                    <FormDescription>
                      Rédigez un commentaire détaillé pour aider les autres
                      clients.
                    </FormDescription>
                  </FormItem>
                )}
